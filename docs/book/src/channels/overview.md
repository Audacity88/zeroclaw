...
| Discord, Slack, Telegram, Signal, iMessage, WeCom Bot Webhook, WeCom AI Bot WebSocket, WeChat personal iLink Bot, DingTalk, Lark, QQ, IRC, Mochat, Notion | per channel | [Other chat platforms](./chat-others.md) |
