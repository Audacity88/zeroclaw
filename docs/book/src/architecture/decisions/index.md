...
| [ADR-017](./ADR-017-runtime-security-and-provenance.md) | proposed | Runtime security and provenance use runtime-owned decision boundaries for protected actions, model admission, internal turns, and canonical evidence. |
...
ADR-017 remains proposed until the runtime action pipeline, ingress/provenance envelope, internal-principal conversation binding, peer reply provenance, separated outcomes, durable audit path, and implementation ratchets meet the acceptance gates in the record.
