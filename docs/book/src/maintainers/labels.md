...
| Contributor-tier labels | Strengthen reviewer trust and contributor experience using `.github/label-policy.json` thresholds. | Update the policy file and this guide together; do not delete or rename tiers as cosmetic cleanup because the labels affect people and review routing. |
