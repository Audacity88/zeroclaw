...
- **Tested revision, interface, and evidence path:** (terminal or viewport dimensions when presentation-sensitive; final supported-interface output path for semantic-only rendered evidence; locale and terminal width when relevant to exact output)
