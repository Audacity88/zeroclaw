...
- **Tested revision, interface, and evidence path:** (include reproduction context when relevant; name the final supported-interface output path for semantic-only rendered evidence; record locale or terminal width when it shapes exact output)
