...
zc-zerocode-tracker-visibility = Visibility
...
zc-zerocode-tracker-edit-visibility = Enter cycles auto / hidden / shown.
zc-zerocode-tracker-edit-location = Enter cycles bottom / left / right.
zc-chat-todo-visibility-save-failed = Tracker visibility changed for this run, but could not be saved: { $error }
zc-chat-todo-visibility-saved-env-override = Tracker visibility was saved, but a ZEROCODE_todotracker__visibility override will take precedence after relaunch.
